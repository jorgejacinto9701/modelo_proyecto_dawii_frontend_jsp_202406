                            ...
                            <div class="form-bottom">
			                    <form id="id_form"  action="login" method="post" class="login-form">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="password" name="password" placeholder="Ingrese Contrase&ntilde;a" class="form-password form-control" id="form-password" maxlength="20" value="luis2023">
			                        </div>
    ...
    $('#id_form').bootstrapValidator({
        ...
        fields: {
            ...
            password: {
                validators: {
                    notEmpty: {
                        message: 'La contrase&ntilde;a es obligatorio'
                    },
                    stringLength :{
