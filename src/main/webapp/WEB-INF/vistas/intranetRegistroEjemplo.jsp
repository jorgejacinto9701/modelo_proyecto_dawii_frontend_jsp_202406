	 ...
	 <div class="col-md-12" style="margin-top: 2%">
			<div class="row">
				<div class="form-group col-md-9">
					...
					<input class="form-control" type="text" id="id_descripcion" name="descripcion" placeholder="Ingrese la descripci&oacute;n">
				</div>
...
$('#id_form').bootstrapValidator({
    ...
    fields: {
    	descripcion: {
            ...
            validators: {
                notEmpty: {
                    message: 'El descripci&oacute;n es un campo obligatorio'
                },
                stringLength :{
                	message:'El descripci&oacute;n es de 5 a 100 caracteres',
                	min : 5,
                	max : 100
                },
            }
        ...
        pais: {
            ...
            validators: {
            	notEmpty: {
                    message: 'Pa&iacute;s es un campo obligatorio'
                },
            }
        },
